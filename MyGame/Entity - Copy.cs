...
namespace MyGame
{
    ...
    {
        private static List<int> availableVBOs = new List<int>();

        //TODO: Now that this class is constructed and destructed VBO no longer has to be nullable 
        private int? VBO;
        ...
        static Entity()
        {
            for (int i = 0; i < Game.entityLimit; i++)
            {
        ...
        public void GenerateVBO()
        {
            if(VBO.HasValue)
            {
                ...
                GL.BindBuffer(BufferTarget.ArrayBuffer, VBO.Value);
